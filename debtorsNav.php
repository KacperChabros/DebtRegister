...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Debtors Navigation - Debt Register</title>
    </head>
    <body>
        <div id="container">
            <header>
            ...
            <section>
                <a href="debtors.php" class="usualLink"><h1>See your debtors</h1></a>
                <a href="manageDebtors.php" class="usualLink"><h1>Manage debtors</h1></a>
                <a href="debtorTop.php" class="usualLink"><h1>Debtor of the month</h1></a>
            </section>
        </div>
    </body>
</html>